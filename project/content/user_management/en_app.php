...
<?php
		if (isset($_GET["add"]))  {
		$title_page = "New user registration";
		...
		if (isset($_POST["submit"])) {
				...
				if ($result) {
						echo '<div class="notification"><div style="background-image: url(/project/source/ui/panel/image/notification_images/ok.png)" class="image"></div><div class="message">User successfully registered</div></div>';
...
?>
																	...
																	<div class="function_line">
																			<a href="/user_management"><p style="margin: 0" class="item">List of users</p></a>
																			<a href="/user_management&add"><p class="item">New user registration</p></a>
																	</div>
																	...
																	<div class="table_place">
																			...
																			<table>
																					<tr class="row_denomination">
																							<td class="column_denomination" colspan="2">Enter data</td>
																					</tr>

																					<tr class="row_data">
																							<td class="column_data">User ID</td>
																					...
																					<tr class="row_data">
																							<td class="column_data">Surname</td>
																					...
																					<tr class="row_data">
																							<td class="column_data">Middle name</td>
																					...
																					<tr class="row_data">
																							<td class="column_data">Password</td>
																					...
																					<tr>
																							<td class="column_submit" colspan="2">
																									<input class="jquery_form" name="submit" type="submit" value="To register">
																							</td>
																					</tr>
																			</table>
																			</form>
...
<?php 
		...
		if (isset($_POST["submit"])) {
				...
				if ($result) {
						echo '<div class="notification"><div style="background-image: url(/project/source/ui/panel/image/notification_images/ok.png)" class="image"></div><div class="message">User successfully deleted</div></div>';
				} else echo '<div class="notification"><div style="background-image: url(/project/source/ui/panel/image/notification_images/error_image.png)" class="image"></div><div class="message">Error during query 1</div></div>';
		}
?>
																	...
																	<div class="table_place">
																			<table style="width: 100%">
																					<tr class="row_denomination">
																							<td class="column_denomination">User ID</td>
																							<td class="column_denomination">Login</td>
																							<td class="column_denomination">Registration date</td>
																							<td class="column_denomination">Name</td>
																							<td class="column_denomination">Surname</td>
																							<td class="column_denomination">Middle name</td>
																							<td class="column_denomination">Access rights</td>
