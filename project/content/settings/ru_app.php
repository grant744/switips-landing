																	...
																	<div class="table_place">
																			...
																			<table>
																					<tr class="row_denomination">
																							<td class="column_denomination" colspan="2">Изменение пароля</td>
																					</tr>

																					<tr class="row_data">
																							<td class="column_data">Ваш пароль</td>
																					...
																					<tr class="row_data">
																							<td class="column_data">Новый пароль</td>
																					...
																					<tr class="row_data">
																							<td class="column_data">Повтор нового пароля</td>
																					...
																					<tr>
																							<td class="column_submit" colspan="2">
																									<input class="jquery_form" name="submit" type="submit" value="Изменить пароль">
																							</td>
																					</tr>
																			</table>
																			</form>
